      ...
      <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#fff;border-radius:12px;overflow:hidden;">
        ...
        <tr><td style="padding:36px 32px;">
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#64748B;line-height:1.6;">
            ${parentName} is asking if you can <strong style="color:#0F172A;">${action} ${kidName}</strong> from the following event:
          </p>

          <div style="background:#F8FAFC;border-radius:10px;padding:20px;margin-bottom:24px;border-left:4px solid #D97706;">
            <p style="margin:0 0 6px;font-size:16px;font-weight:600;color:#0F172A;">${eventName}</p>
            <p style="margin:0 0 4px;font-size:14px;color:#64748B;">📅 ${eventDate} at ${eventTime}</p>
            ${event.location ? `<p style="margin:0;font-size:14px;color:#64748B;">📍 ${event.location}</p>` : ''}
            ${note ? `<p style="margin:8px 0 0;font-size:13px;color:#0F172A;font-style:italic;">"${note}"</p>` : ''}
          </div>

          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td style="padding-right:8px;">
                <a href="${confirmUrl}" style="display:block;background:#D97706;color:#fff;font-weight:700;font-size:15px;padding:14px;border-radius:8px;text-decoration:none;text-align:center;">
                  ✓ Yes, I can ${action}
                </a>
              </td>
              <td style="padding-left:8px;">
                <a href="${declineUrl}" style="display:block;background:#F8FAFC;color:#64748B;font-weight:600;font-size:15px;padding:14px;border-radius:8px;text-decoration:none;text-align:center;border:1px solid #E4ECFC;">
                  Sorry, I can't
                </a>
              </td>
            </tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 16px;">
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#fff;border-radius:12px;overflow:hidden;">
        ...
        <tr><td style="padding:36px 32px;">
          <p style="margin:0 0 16px;font-size:22px;font-weight:600;color:#0F172A;">
            ${confirmed ? '✅' : '❌'} ${logistics.contact_name} has ${confirmed ? 'confirmed' : 'declined'}
          </p>
          <p style="margin:0 0 20px;font-size:15px;color:#64748B;line-height:1.6;">
            <strong style="color:#0F172A;">${logistics.contact_name}</strong> has 
            ${confirmed ? 'confirmed' : 'declined'} the 
            <strong style="color:#0F172A;">${logistics.role}</strong> for:
          </p>
          <div style="background:#F8FAFC;border-radius:10px;padding:20px;border-left:4px solid ${confirmed ? '#D97706' : '#ef4444'};">
            <p style="margin:0 0 6px;font-size:16px;font-weight:600;color:#0F172A;">${eventName}</p>
            <p style="margin:0 0 4px;font-size:14px;color:#64748B;">📅 ${eventDate} at ${eventTime}</p>
            ${logistics.location ? `<p style="margin:0;font-size:14px;color:#64748B;">📍 ${logistics.location}</p>` : ''}
          </div>
          ${!confirmed ? '<p style="margin:20px 0 0;font-size:14px;color:#64748B;">You may want to arrange an alternative.</p>' : ''}
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#fff;border-radius:12px;overflow:hidden;">
        ...
        <tr><td style="padding:36px 32px;">
          ...
          <div style="background:#F8FAFC;border-radius:10px;padding:20px;margin-bottom:24px;border-left:4px solid #D97706;">
            <p style="margin:0 0 6px;font-size:16px;font-weight:600;color:#0F172A;">${action_label}: ${eventName}</p>
            <p style="margin:0 0 4px;font-size:14px;color:#64748B;">📅 ${eventDate} at ${eventTime}</p>
            ${logistics.location ? `<p style="margin:0;font-size:14px;color:#64748B;">📍 ${logistics.location}</p>` : ''}
          </div>
          <p style="margin:0;font-size:13px;color:#b8c4d8;line-height:1.6;">
